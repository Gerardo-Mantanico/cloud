export const Home = () => {
    return (
        <div className="mt-5 d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <img src="logo.png" alt="logo" style={{ width: '300px', height: '200px' }} className="mb-4" />
            <div className="bg-gray-100 p-4 rounded-lg shadow-md" style={{width: '500px',height: '200px'}}>
